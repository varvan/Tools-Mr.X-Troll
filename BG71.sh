...
echo $me"       *Y888888888888888            Mr.X-Troll          *Y88888888888888P="
...
echo $pur"|          Mr.X-Troll HACKING TOOLS            |"
echo $pur"|         Tools BY:Unknown / Mr.X-Troll.       |"
echo $pur"|       Channel Youtube:Garis GaminG           |"
echo $cy"|           Facebook:Varvan Ilham M            |"
echo $cy"|             instagram:varvan.ilham           |"
...
cd /sdcard/BloodsTools71/10Attack
sh attack.sh
fi
...
sleep 2
echo $ku"WhatsApp :"$i" 082313234485"
